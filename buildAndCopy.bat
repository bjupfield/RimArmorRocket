...
"C:\Program Files (x86)\Microsoft Visual Studio\2022\BuildTools\MSBuild\Current\Bin\MSBuild.exe" ArmorRocket.sln /t:Build /p:Configuration=Release
...
copy "C:\Users\bjupf\Desktop\RimWorldModding\ArmorRocket\Source\ArmorRocket\bin\Release\ArmorRocket.dll" "C:\Users\bjupf\Desktop\RimWorldModding\ArmorRocket\ArmorRocket\Common\Assemblies"
echo "Transfered Dll"
