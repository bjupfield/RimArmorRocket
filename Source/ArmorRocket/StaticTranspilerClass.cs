...
namespace ArmorRocket
{
    ...
    //            if (thing40 as ArmorRocketThing != null)
    //            {
    ...
    //    {
    //        int? b = ((MapComponentHeavyRoofGrid)comps.Find(d => d.GetType() == typeof(ArmorRocket.MapComponentHeavyRoofGrid)))?.roofType(grid, c);
    //        if (b == null)
    //            return 0;
    //        else 
    //        {
    ...
    //    {
    //        return ((ArmorRocket.MapComponentHeavyRoofGrid)comps.Find(c => c.GetType() == typeof(ArmorRocket.MapComponentHeavyRoofGrid)))?.retrieveBlue();
    //    }
    //    public static PathingContext retrieveHeavyRoof(ref List<MapComponent> comps)
    //    {
    //        return ((ArmorRocket.MapComponentHeavyRoofGrid)comps.Find(c => c.GetType() == typeof(ArmorRocket.MapComponentHeavyRoofGrid)))?.retrieveContext();
    //    }
